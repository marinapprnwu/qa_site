...
public class OrderPage {
    private SelenideElement opticsCatalogButton =  $("div.main-links-wrap").$(byText("оптика")),
    ...
    public void orderConfirmedSuccessfully() {
        $("div.reg-popup-text").shouldHave(text("При регистрации на сайте у вас появится"));
    }
